...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  void _getForecast() {
    setState(() {
      _forecast = List.generate(7, (index) => ForecastDay(
        date: DateTime.now().add(Duration(days: index + 1)),
        minTemp: 15.0 + index,
        maxTemp: 25.0 + index,
        description: ['Sunny', 'Cloudy', 'Rainy', 'Clear', 'Windy', 'Snow', 'Stormy'][index],
        icon: '01d',
        conditionId: 800,
      ));
    });
            ...
            SliverAppBar(
              ...
              flexibleSpace: LayoutBuilder(
                builder: (context, constraints) {
                  final opacity = (constraints.maxHeight - kToolbarHeight) / (140 - kToolbarHeight);
                  return Stack(
                    children: [
                      ...
                      if (_currentWeather != null)
                        Center(
                          child: Padding(
                            ...
                            child: _getWeatherIcon(_currentWeather!.conditionId),
                          ),
                        ),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            icon: Icon(CupertinoIcons.paperplane, color: Colors.white.withOpacity(0.7)),
